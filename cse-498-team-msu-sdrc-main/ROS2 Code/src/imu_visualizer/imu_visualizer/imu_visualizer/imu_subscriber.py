...
class IMUVisualizer(Node):
    """Class to visualize the IMU data. Subscribes to the IMU data topic"""
    def __init__(self):
        """Initialize the node"""
    ...
    def create_cylinder(self, radius=1, height=3, resolution=30):
        """Create the shape of the IMU as cylinder"""
    ...
    def imu_graph(self, msg):
        """Update the IMU based on the rotation angles"""
        dt = 0.05
